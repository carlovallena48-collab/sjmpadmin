...
const LOG_URL = "http://localhost:5000/api/dashboard/activity-log";
const BAPTISM_API = "http://localhost:5000/api/baptism";
const CONFIRMATION_API = "http://localhost:5000/api/confirmation";
const MATRIMONY_API = "http://localhost:5000/api/matrimony";
const EUCHARIST_API = "http://localhost:5000/api/eucharist";
const HOLY_ORDERS_API = "http://localhost:5000/api/holy-orders";
const PAMISA_API = "http://localhost:5000/api/pamisa";
const FUNERAL_API = "http://localhost:5000/api/funeralrequests";
const BLESSING_API = "http://localhost:5000/api/blessing";
const CERTIFICATE_API = "http://localhost:5000/api/certificates";
